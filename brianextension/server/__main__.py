...
from .server import brian_server

logging.basicConfig(filename="pygls.log", level=logging.DEBUG, filemode="w")


def add_arguments(parser):
    parser.description = "Brian LSP server"
...
def main():
    ...
    if args.tcp:
        brian_server.start_tcp(args.host, args.port)
    elif args.ws:
        brian_server.start_ws(args.host, args.port)
    else:
        brian_server.start_io()
